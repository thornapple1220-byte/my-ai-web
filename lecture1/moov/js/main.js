...
const FALLBACK_CONTENTS = [
  { id:1, title:'블레이드 런너 2049', genre:'SF · 액션', info:'2017 · 163분',
    image_url:'https://images.unsplash.com/photo-1478720568477-152d9b164e26?w=600&h=900&fit=crop&q=90&auto=format',
  ...
  { id:2, title:'듄: 파트 2', genre:'SF · 어드벤처', info:'2024 · 166분',
    image_url:'https://images.unsplash.com/photo-1419242902214-272b3f66ee7a?w=600&h=900&fit=crop&q=90&auto=format',
    badge:'HOT', rating:8.5, description:'예언자가 된 폴 아트레이데스와 프레멘 전사들의 운명적인 아라키스 해방 전쟁' },
  { id:3, title:'오펜하이머', genre:'드라마 · 전쟁', info:'2023 · 180분',
    image_url:'https://images.unsplash.com/photo-1516979187457-637abb4f9353?w=600&h=900&fit=crop&q=90&auto=format',
    badge:null, rating:8.5, description:'세상을 영원히 바꾼 원자폭탄 개발자 로버트 오펜하이머의 영광과 비극' },
  { id:4, title:'매트릭스', genre:'SF · 액션', info:'1999 · 136분',
    image_url:'https://images.unsplash.com/photo-1542204165-65bf26472b9b?w=600&h=900&fit=crop&q=90&auto=format',
    badge:null, rating:8.7, description:'현실이라 믿어온 세계가 기계가 만든 거대한 시뮬레이션이었다는 충격적 진실' },
  { id:5, title:'인터스텔라', genre:'SF · 드라마', info:'2014 · 169분',
    image_url:'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=600&h=900&fit=crop&q=90&auto=format',
  ...
  { id:6, title:'기생충', genre:'드라마 · 블랙코미디', info:'2019 · 132분',
    image_url:'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=600&h=900&fit=crop&q=90&auto=format',
    badge:null, rating:8.5, description:'반지하 가족과 고급 저택 부유층 사이에서 벌어지는 계급의 비밀과 충돌' },
  { id:7, title:'더 배트맨', genre:'액션 · 누아르', info:'2022 · 176분',
    image_url:'https://images.unsplash.com/photo-1518676590629-3dcbd9c5a5c9?w=600&h=900&fit=crop&q=90&auto=format',
    badge:'4K', rating:7.9, description:'고담의 어둠 속에서 연쇄 살인마를 추적하는 배트맨의 가장 어두운 이야기' },
  { id:8, title:'1917', genre:'전쟁 · 드라마', info:'2019 · 119분',
    image_url:'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=600&h=900&fit=crop&q=90&auto=format',
    badge:null, rating:8.3, description:'아군을 구하기 위해 적진을 가로질러야 하는 두 병사의 숨막히는 실시간 여정' },
];

const FALLBACK_RECS = [
  { id:1, title:'테넷', genre:'SF · 스릴러',
    image_url:'https://images.unsplash.com/photo-1500462918059-b1a0cb512f1d?w=600&h=900&fit=crop&q=90&auto=format',
    description:'시간을 역행하는 비밀 요원의 세계 구원 임무' },
  { id:2, title:'킹덤: 아신전', genre:'사극 · 스릴러',
    image_url:'https://images.unsplash.com/photo-1536440136628-849c177e76a1?w=600&h=900&fit=crop&q=90&auto=format',
    description:'조선 시대 좀비 재앙의 기원을 담은 충격적 프리퀄' },
  { id:3, title:'올드보이', genre:'스릴러 · 미스터리',
    image_url:'https://images.unsplash.com/photo-1446776653964-20c1d3a81b06?w=600&h=900&fit=crop&q=90&auto=format',
    description:'15년간 이유도 모른 채 감금됐다 풀려난 한 남자의 처절한 복수' },
  { id:4, title:'승리호', genre:'SF · 액션',
    image_url:'https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?w=600&h=900&fit=crop&q=90&auto=format',
